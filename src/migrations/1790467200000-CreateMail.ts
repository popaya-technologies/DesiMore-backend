...
export class CreateMail1790467200000 implements MigrationInterface {
 name = "CreateMail1790467200000";
...
ON CONFLICT ("name") DO NOTHING;`);
 ...
 async down(queryRunner: QueryRunner): Promise<void> {
  await queryRunner.query('DROP TABLE "mail_requests"; DROP TABLE "newsletter_subscribers";');
