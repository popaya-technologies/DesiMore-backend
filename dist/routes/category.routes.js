...
router.get("/all", auth_middleware_1.authenticate, (0, rbac_middleware_1.checkPermission)("category", "read"), category_controller_1.CategoryController.getAllCategoriesAdmin);
